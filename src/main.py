...
def get_rtvslo_data():
    ...
    rtvslo_02 = open( '../data/rtvslo.si/Volvo XC 40 D4 AWD momentum_ suvereno med najboljše v razredu - RTVSLO.si.html', encoding='utf-8' ).read()
...
if __name__ == '__main__':
    ...
    # [print(x) for x in get_github_data_xpath()]
    #print_rtvslo_data()
